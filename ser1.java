...
public class ser1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //out.println("<form action='http://localhost:8080/servlet/cookiereg' method='post'>");
            out.println("<a href='http://localhost:8080/servlet/cookiereg'>click me to go welcome page</a>");
           // out.println("</form>");
            out.println("</body>");
            out.println("</html>");
        }
